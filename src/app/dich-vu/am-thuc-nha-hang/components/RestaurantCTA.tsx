...
const RestaurantCTA: FC = () => {
  return (
    <section className="section-pad relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-amber-950/20 via-brand-deep-space to-brand-catchie-navy/20" />
      ...
      <div className="page-container relative z-10">
        <div className="cosmic-surface rounded-3xl p-10 md:p-16 text-center relative overflow-hidden">
          <div className="absolute top-0 left-0 w-40 h-40 bg-amber-500/8 rounded-full blur-[60px]" />
          ...
          <div className="relative">
            ...
            <p className="text-white/60 text-lg max-w-xl mx-auto mb-10 leading-relaxed">
              ...
              website nhà hàng ẩm thực đẳng cấp, thu hút hàng trăm khách mới mỗi tháng.
            </p>
            ...
            <div className="mt-12 pt-8 border-t border-white/[0.07]">
              <div className="flex flex-wrap items-center justify-center gap-8 md:gap-14">
                {[
                  { value: '80+', label: 'Nhà hàng đã tin dùng' },
                  { value: '+280%', label: 'Đặt bàn online tăng' },
