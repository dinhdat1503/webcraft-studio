...
const RestaurantHero: FC = () => {
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden">
      {/* Background effects */}
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-br from-brand-deep-space via-amber-950/20 to-brand-deep-space" />
      ...
      <div className="page-container relative z-10 pt-32 pb-20">
        ...
        <nav className="flex items-center gap-2 text-sm text-white/40 mb-10 animate-fade-in-down">
          ...
          <span>/</span>
          <span className="text-brand-catchie-blue font-medium">Ẩm Thực & Nhà Hàng</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="animate-fade-in-up">
            <span className="inline-flex items-center gap-2 text-[11px] font-bold tracking-[0.2em] uppercase text-brand-catchie-blue mb-6
              ...
              Restaurant & F&B Solutions
            </span>

            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-[1.05] tracking-tight mb-6">
              <span className="text-white">Website Ẩm Thực</span>
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-brand-catchie-blue">
                & Nhà Hàng
              </span>
            </h1>

            <p className="text-lg md:text-xl text-white/60 leading-relaxed max-w-lg mb-10">
              Mang trải nghiệm ẩm thực đỉnh cao lên không gian số. Hệ thống đặt bàn thông minh,
              thực đơn trực tuyến hấp dẫn và quản lý đặt chỗ chuyên nghiệp.
            </p>
          ...
          <div className="relative animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <div className="relative rounded-2xl overflow-hidden cosmic-surface">
              <div className="absolute -inset-1 bg-gradient-to-r from-amber-500/20 via-transparent to-brand-catchie-blue/20 rounded-2xl blur-sm" />
              <div className="relative aspect-[16/10] rounded-2xl overflow-hidden">
                <Image
                  src="/assets/portfolio/portfolio_restaurant.png"
                  alt="Website nhà hàng ẩm thực cao cấp preview"
                  fill
            ...
            <div className="absolute -bottom-4 -left-4 cosmic-surface rounded-xl px-5 py-3 animate-float">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-white font-bold text-sm">Đặt bàn 24/7</p>
                  <p className="text-white/50 text-xs">Online Booking System</p>
                </div>
              </div>
            </div>
            {/* Floating badge 2 */}
