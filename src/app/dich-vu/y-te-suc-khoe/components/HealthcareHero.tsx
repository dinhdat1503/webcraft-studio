  ...
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-br from-brand-deep-space via-teal-950/20 to-brand-deep-space" />
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-teal-500/6 rounded-full blur-[120px]" />
      ...
      <div className="page-container relative z-10 pt-32 pb-20">
        <nav className="flex items-center gap-2 text-sm text-white/40 mb-10 animate-fade-in-down">
          ...
          <span>/</span>
          <span className="text-brand-catchie-blue font-medium">Y Tế & Sức Khỏe</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="animate-fade-in-up">
            ...
            <p className="text-lg md:text-xl text-white/60 leading-relaxed max-w-lg mb-10">
              Nền tảng y tế số toàn diện với đặt lịch hẹn trực tuyến, hồ sơ bệnh nhân điện tử,
              telemedicine và quản lý phòng khám chuyên nghiệp.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                ...
                className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-heading font-bold text-white
                  ...
                  hover:bg-teal-500 hover:border-teal-400 hover:shadow-[0_0_30px_rgba(20,184,166,0.5)] hover:-translate-y-1
          ...
          <div className="relative animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <div className="relative rounded-2xl overflow-hidden cosmic-surface">
              <div className="absolute -inset-1 bg-gradient-to-r from-teal-500/25 via-transparent to-brand-catchie-blue/20 rounded-2xl blur-sm" />
              <div className="relative aspect-[16/10] rounded-2xl overflow-hidden">
                <Image
                  src="/assets/portfolio/portfolio_healthcare.png"
                  alt="Website y tế phòng khám chuyên nghiệp"
                  fill
            ...
            <div className="absolute -bottom-4 -left-4 cosmic-surface rounded-xl px-5 py-3 animate-float">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-white font-bold text-sm">Đặt lịch 24/7</p>
                  <p className="text-white/50 text-xs">Online Appointment</p>
                </div>
              </div>
            </div>
            <div className="absolute -top-4 -right-4 cosmic-surface rounded-xl px-5 py-3 animate-float" style={{ animationDelay: '1.5s' }}>
              <div className="flex items-center gap-2">
                ...
                <span className="text-white text-xs font-bold">500+ bác sĩ</span>
              </div>
            </div>
          </div>
        </div>
